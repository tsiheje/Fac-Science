                    ...
                    <div className="about-service">
                        <div className="text-service">
                            ...
                            <div className="text-service-phrase">
                                <p>Bienvenue sur One Note, une plateforme éducative novatrice conçue pour améliorer l'expérience d'apprentissage tant pour les étudiants que pour les enseignants.</p> 
                                <p>Notre plateforme offre une interface conviviale avec une navigation facile, permettant aux utilisateurs d'accéder à divers menus tels que l'accueil, les annonces, les cours et les devoirs.</p>
                                <p>Dans le menu 'annonces', les enseignants peuvent publier des mises à jour importantes et des informations, tandis que le menu 'cours' offre une plateforme aux enseignants pour publier leurs cours.</p>
                                <p> De plus, le menu 'devoirs' permet aux étudiants d'accéder et de soumettre leurs devoirs. Avec notre plateforme, les ressources sont présentées sous forme de cartes attrayantes, avec la date de publication et le nom de la personne ayant publié les ressources. Rejoignez-nous dans cette excitante aventure de l'éducation et du savoir !</p>
                            </div>
                        </div>
                        <div className="text-professeur">
                            <div className="text-professeur-left">
                                <h3 className="titre">Large éventail de cours</h3>
                                <p>À One Note, nous proposons une large gamme de cours via notre menu 'Cours'.Nos enseignants expérimentés couvrent une variété de sujets, veillant à ce qu'il y en ait pour tous les goûts.</p>
                                <p>Que vous soyez intéressé par des matières académiques telles que les mathématiques et les sciences, ou que vous souhaitiez explorer des domaines créatifs comme l'art et la musique, nos cours offrent une expérience d'apprentissage complète.En plus de nos cours, nous offrons également une multitude de ressources via notre menu 'Devoirs'.</p>
                                <p>Ces ressources sont conçues pour compléter votre apprentissage et vous aider à exceller dans vos études. Des exercices pratiques aux guides d'étude, nos ressources apportent un soutien précieux pour améliorer votre compréhension des sujets.Explorez nos menus 'Cours' et 'Devoirs' pour découvrir les opportunités éducatives disponibles sur One Note !</p>
                            </div>
                        ...
                        <div className="text-etudiant">
                            ...
                            <div className="text-etudiant-right">
                                <h3 className="titre">Ressources éducatives</h3>
                                <p>Notre menu 'Cours' offre une vaste gamme d'opportunités éducatives pour des étudiants de tous âges. Des matières académiques aux cours axés sur les compétences, nos enseignants sont dédiés à fournir un enseignement de haute qualité qui favorise la croissance et l'apprentissage.</p>
                                <p>Chaque cours est soigneusement conçu pour répondre aux besoins et aux intérêts de nos étudiants, garantissant une expérience éducative enrichissante.En plus de nos cours, nous proposons également une variété de ressources dans notre menu 'Devoirs'. Ces ressources sont créées par nos enseignants et fournissent des matériaux d'apprentissage précieux pour compléter les cours.</p>
                                <p>Qu'il s'agisse de guides d'étude, de quiz pratiques ou d'activités interactives, nos ressources sont conçues pour améliorer le processus d'apprentissage et aider les étudiants à réussir.Explorez nos menus 'Cours' et 'Devoirs' pour découvrir les opportunités éducatives disponibles sur One Note !</p>
                            </div>
                        </div>
                    </div>
