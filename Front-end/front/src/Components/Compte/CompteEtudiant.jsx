...
import './Compte.css';
import sary from '../../Assets/Images/pexels-armin-rimoldi-5553074.jpg';

const CompteEtudiant = ({ onClose }) => {
        ...
        <div className="cont">
          <div className="compte-content">
            <div className="fermer" onClick={ onClose }>X</div>
              <div className="anaty-compte">
                <div className="left-compte">
                      <img src={sary} alt="" />
                      <div className="kozy">
                          <h1>One Note</h1>
                          <p>"Bienvenue sur One Note ! Créez votre compte dès maintenant pour plonger dans un univers d'apprentissage interactif et de communication efficace. Démarrez votre parcours éducatif personnalisé et restez connecté avec notre communauté dynamique. L'éducation et la communication n'ont jamais été aussi accessibles. Rejoignez-nous aujourd'hui !"</p>
                      </div>
                </div>
